        ...
        <header>
            ...
            <div className={styles.headerBot}>
                <nav>
                    <ul>
                        {listLinks.map(link => (
                            <ListTextSmall text={link.text} size="12px" link={link.url ? link.url : ""}/>
                        ))}
                    </ul>
                </nav>
            </div>
