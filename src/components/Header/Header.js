...
const Header = () => {
  const listLinks = [
    { text: "World", url: "/world" },
    { text: "U.S." },
    { text: "Politics", url: "politics" },
    { text: "N.Y." },
    { text: "Business" },
    { text: "Opinion" },
    { text: "Tech", url: "/technology" },
    { text: "Science", url: "/science" },
        ...
        <div>
          <div>
            <svg width="18" height="18" viewBox="0 0 34 34">
              <title>Today's weather: 19°C and Cloudy</title>
